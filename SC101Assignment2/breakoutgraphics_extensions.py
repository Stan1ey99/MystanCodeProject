...
BRICK_ROWS = 9        # Number of rows of bricks
BRICK_COLS = 9        # Number of columns of bricks
...
class BreakoutGraphics:
    ...
    def __init__(self, ball_radius=BALL_RADIUS, paddle_width=PADDLE_WIDTH, paddle_height=PADDLE_HEIGHT,
        ...
        self.loss_game_label = GLabel('討つらしい')
        self.loss_game_label.font = 'Courier-35-italic'
        self.window.add(loss_game_label)
        ...
        for i in range(brick_rows+1):
            ...
            for j in range(brick_cols):
                ...
                self.bricks.filled = True
                if j <= 0:
                    self.bricks.fill_color = 'white'
                elif j == 1 and i == 1 or j == 1 and 4 <= i <= 6 or j == 1 and i == 9:
                    self.bricks.fill_color = 'white'
                elif j == 2 and i == 5:
                    self.bricks.fill_color = 'white'
                elif j == 5 and i == 1 or j == 5 and i == 9:
                    self.bricks.fill_color = 'white'
                elif j == 6 and 1 <= i <= 2 or j == 6 and 8 <= i <= 9:
                    self.bricks.fill_color = 'white'
                elif j == 7 and 1 <= i <= 3 or j == 7 and 7 <= i <= 9:
                    self.bricks.fill_color = 'white'
                elif j == 8 and 1 <= i <= 4 or j == 8 and 6 <= i <= 9:
                    self.bricks.fill_color = 'white'
                else:
                    self.bricks.fill_color = 'red'
                self.window.add(self.bricks)
